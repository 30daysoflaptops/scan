...
jQuery(function($){
	...
	$('#file-uploader').html('<diERROR!
v class="qq-uploader"><div id="uploadedfile" class="qq-upload-button btn bg-teal btn-sm btn-raised position-left" style="width: auto;">{$lang['xfield_xfim']}</div></div>');
