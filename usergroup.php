...
if( $action == "del" ) {
    ...
    $max_downloads = intval($_REQUEST['max_downloads']);
    ...
    $admin_links = intval($_REQUEST['admin_links']);
    $admin_redirects = intval($_REQUEST['admin_redirects']);
    $admin_meta = intval($_REQUEST['admin_meta']);
    ...
    $allow_change_storage = intval($_REQUEST['allow_change_storage']);
    ...
    $self_delete = intval($_REQUEST['self_delete']);
	...
	$force_comments_rating = intval( $_REQUEST['force_comments_rating'] );
	$force_comments_rating_count = intval( $_REQUEST['force_comments_rating_count'] );
	$force_comments_rating_group = intval( $_REQUEST['force_comments_rating_group'] );
    ...
    if ($user_group[$id]['allow_change_storage']) $allow_change_storage = "checked";
    ...
    if ($user_group[$id]['admin_links']) $admin_links = "checked";
    if ($user_group[$id]['admin_redirects']) $admin_redirects = "checked";
    if ($user_group[$id]['admin_meta']) $admin_meta = "checked";
	...
	if( $user_group[$id]['force_comments_rating'] ) $force_comments_rating = "checked";
